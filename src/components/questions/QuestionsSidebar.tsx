...
const AllTypesIcon = () => <svg className="w-4 h-4" focusable="false" aria-hidden="true" viewBox="0 0 512 512" fill="currentColor">
...
const MultipleChoiceIcon = () => <svg className="w-4 h-4" focusable="false" aria-hidden="true" viewBox="0 0 512 512" fill="currentColor">
...
const OpenAnswerIcon = () => <svg className="w-4 h-4" focusable="false" aria-hidden="true" viewBox="0 0 640 512" fill="currentColor">
...
const TrueFalseIcon = () => <svg className="w-4 h-4" focusable="false" aria-hidden="true" viewBox="0 0 640 512" fill="currentColor">
...
const MatchingIcon = () => <svg className="w-4 h-4" focusable="false" aria-hidden="true" viewBox="0 0 576 512" fill="currentColor">
...
export function QuestionsSidebar({
  ...
  return <div className="w-full bg-white flex flex-col h-full">
      ...
      <div className="h-[57px] px-6 border-b border-gray-200 flex items-center justify-between flex-shrink-0">
        ...
        <button onClick={onCreateQuestion} className="p-1.5 hover:bg-gray-100 rounded transition-colors">
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        ...
        <div className="space-y-1">
          {TYPES.map((type) => <button key={type.id} onClick={() => onSelectType(type.id)} className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors ${selectedType === type.id ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50'}`}>
      ...
      <div className="px-6 py-4 flex-1 overflow-y-auto">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-1 relative">
            ...
            <button onClick={() => setShowMenu(!showMenu)} className="p-1 hover:bg-gray-100 rounded transition-colors">
        ...
        <div className="space-y-1">
          {CATEGORIES.map((category) => <button key={category.id} onClick={() => onSelectCategory(category.id)} className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors ${selectedCategory === category.id ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50'}`}>
