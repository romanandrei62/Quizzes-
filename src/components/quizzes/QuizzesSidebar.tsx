  ...
  return <div className="w-full bg-white flex flex-col h-full">
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        ...
        <div className="space-y-1">
          ...
          return <button key={status.id} onClick={() => onSelectStatus(status.id)} className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors ${selectedStatus === status.id ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50'}`}>
