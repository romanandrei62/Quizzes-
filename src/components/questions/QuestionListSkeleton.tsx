  ...
  return (
    <div
      ...
      <div className="flex items-center py-3 sm:py-4 flex-shrink-0 pl-3 sm:pl-0">
        <div
          className="w-1 h-12 rounded-full bg-gray-200 animate-pulse"
          style={{
            animationDelay: `${index * 75}ms`
          }} />
      ...
      <div className="flex-1 flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-3 sm:py-4 min-w-0">
        {/* Type Icon */}
        <div
          className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-gray-100 animate-pulse flex-shrink-0"
          style={{
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start gap-2 sm:gap-3">
            <div className="flex-1 min-w-0">
              ...
              <div
                className="hidden xs:block h-3 bg-gray-100 rounded mt-2 animate-pulse"
                style={{
            ...
            {/* Status Icon */}
            <div
              className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-gray-100 animate-pulse flex-shrink-0"
              style={{
        ...
        {/* Actions placeholder */}
        <div
          className="w-6 h-6 rounded bg-gray-50 animate-pulse flex-shrink-0"
          style={{
...
export function QuestionListSkeleton({ count = 8 }: QuestionListSkeletonProps) {
  return (
