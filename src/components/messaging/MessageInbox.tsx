...
const MOCK_MESSAGES: Message[] = [
{
  ...
  preview:
  'I wanted to discuss the latest changes to the project scope. We need to adjust the timeline and deliverables accordingly',
...
},
{
  ...
  preview:
  "Here are the slides for tomorrow's presentation. Please review them before the meeting starts and let me know if you have any feedback",
...
},
{
  ...
  preview:
  'Attached is the comprehensive report on our Q1 marketing campaigns and their performance metrics across all channels',
...
},
{
  ...
  preview:
  'Hey! Just wanted to check in quickly about the client meeting scheduled for next week.',
...
},
{
  ...
  preview:
  'Please find attached the invoice for the services rendered in December. Payment is due by the end of the month',
...
},
{
  ...
  preview:
  'The issue reported regarding the staging server has been fixed. You can now deploy your changes without any problems',
    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="px-4 md:px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-white">
        ...
        <div className="relative">
          ...
          <button
            onClick={() => setIsMailboxMenuOpen(!isMailboxMenuOpen)}
            className="lg:hidden flex items-center gap-2 text-lg font-semibold text-gray-900 hover:text-gray-700 transition-colors">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <motion.div
          ...
          <motion.div
            key={message.id}
            variants={item}
            className={`flex items-center gap-4 px-4 md:px-6 py-4 md:py-5 ${index !== filteredMessages.length - 1 ? 'border-b border-gray-100' : ''} cursor-pointer ${message.isPinned ? 'bg-blue-50/30' : ''} transition-colors`}
            onClick={() => {
              ...
              className="flex-shrink-0 hidden md:block" />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="md:hidden">
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      <div className="flex items-center gap-1.5 flex-1 min-w-0">
                        <h3
                      className={`text-sm truncate ${message.isUnread ? 'font-semibold text-gray-900' : 'font-normal text-gray-700'}`}>
                    ...
                    <div className="flex items-center gap-0.5 px-1.5 py-0.5 bg-teal-100 text-teal-700 rounded-full flex-shrink-0">
                    ...
                    {/* Middle Row: Subject */}
                    <div
                  className={`text-sm mb-1 ${message.isUnread ? 'font-semibold text-gray-900' : 'text-gray-700'}`}>
                    ...
                    <Pin className="h-4 w-4 text-gray-400" />
                      ...
                      <button
                    onClick={(e) => handleToggleReadStatus(message.id, e)}
                    className="p-1.5 hover:bg-gray-100 rounded transition-colors">

                        {message.isUnread ?
                    <MailOpen className="h-4 w-4 text-teal-500" /> :
                  ...
                  <div className="hidden md:block">
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      <h3
                    className={`text-[15px] truncate ${message.isUnread ? 'font-semibold text-gray-900' : 'font-normal text-gray-700'}`}>
                  ...
                  <span className="text-xs flex-shrink-0 text-gray-400">
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      <div
                    className={`text-sm truncate ${message.isUnread ? 'font-semibold text-gray-900' : 'text-gray-700'}`}>
                      ...
                      {message.replyCount && message.replyCount > 0 &&
                  <div
                    className={`flex items-center gap-1 px-2 py-0.5 rounded-full text-xs flex-shrink-0 ${message.isUnread ? 'bg-teal-100 text-teal-700 font-medium' : 'bg-gray-100 text-gray-600'}`}>
            ...
            <div className="space-y-2">
              ...
              className="w-full flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                ...
                <span className="font-medium">
                  {messages.find((m) => m.id === mobileActionMessageId)?.
                isPinned ?
                'Unpin' :
                'Pin to top'}
                </span>
