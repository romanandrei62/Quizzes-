...
const MOCK_CANNED_RESPONSES: CannedResponse[] = [
{
  ...
  autoReply: true,
  content:
  'Thank you for your message. I am currently out of office and will respond when I return.',
  color: '#8B5CF6'
},
{
  id: '2',
  ...
  autoReply: false,
  content:
  'Thank you for reaching out. I would be happy to schedule a meeting. Please let me know your availability.',
  color: '#EC4899'
},
{
  id: '3',
  ...
  autoReply: false,
  content:
  'Following up on our previous conversation. Please let me know if you have any questions.',
  color: '#10B981'
},
{
  id: '4',
    ...
    <div className="flex flex-col h-full bg-white">
        ...
        <div className="flex items-center gap-3">
          <div className="relative group">
            <button
              ...
              className="flex items-center justify-center w-9 h-9 bg-teal-600 text-white rounded-full hover:bg-teal-700 hover:shadow-md active:scale-95 transition-all"
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <EmptyState
          ...
          actionLabel={filterType === 'all' ? 'Create Response' : undefined}
          actionIcon={filterType === 'all' ? Plus : undefined}
          onAction={
          filterType === 'all' ?
          () => {
            setEditingResponse(null);
        ...
        <motion.div variants={container} initial="hidden" animate="show">
          ...
          <motion.div
            key={response.id}
            variants={item}
            className={`flex items-center gap-4 px-4 md:px-6 py-4 md:py-5 ${index !== filteredResponses.length - 1 ? 'border-b border-gray-100' : ''} hover:bg-gray-50 transition-colors cursor-pointer`}
            onClick={(e) => handleEdit(response.id, e)}
      ...
      <AnimatePresence>
        ...
        <motion.div
          ...
          className={`fixed inset-0 z-50 flex justify-center ${isExpanded ? 'items-stretch lg:items-end bg-white lg:bg-black/50 lg:backdrop-blur-sm' : 'items-end bg-black/50 backdrop-blur-sm'}`}
          onClick={isExpanded ? undefined : () => setShowModal(false)}>
            ...
            layout
            className={`w-full bg-white shadow-2xl overflow-hidden flex flex-col ${isExpanded ? 'lg:max-w-6xl lg:max-h-[90vh] lg:rounded-t-2xl max-h-screen rounded-none' : 'max-w-2xl max-h-[700px] rounded-t-2xl'}`}
            onClick={(e) => e.stopPropagation()}>
              ...
              <div className="flex-1 overflow-y-auto">
                <div
                className={`p-6 ${isExpanded ? 'space-y-6' : 'space-y-3'}`}>
                    ...
                    <>
                        ...
                        onClick={() => setShowColorPicker(false)} />
                          ...
                          <button
                            ...
                            className={`w-8 h-8 rounded transition-all hover:scale-110 ${formData.color === color ? 'ring-2 ring-offset-2 ring-gray-400' : ''}`}
                            style={{
                            ...
                            className="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none"
                            placeholder="#000000" />
