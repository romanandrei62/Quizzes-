...
export function QuestionsPage() {
  ...
  return <div className="h-screen flex bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden pt-14 lg:pt-0 bg-gray-50">
        ...
        <div ref={containerRef} className="flex-1 flex gap-4 px-4 pb-4 overflow-hidden">
          ...
          width: `${rightWidth}px`
            ...
            {activeTab === 'questions' ? <QuestionDetail key={detailKey} question={selectedQuestion} onClose={() => setSelectedQuestion(null)} defaultTab={detailDefaultTab} onSave={handleSaveQuestion} onDelete={handleDeleteQuestion} /> : <QuizDetail quiz={selectedQuiz} onClose={() => setSelectedQuiz(null)} />}
          </div>
        </div>
      </div>
      ...
      backgroundColor: '#ffffff'
          ...
          <QuestionDetail key={`overlay-${detailKey}`} question={selectedQuestion} onClose={() => setSelectedQuestion(null)} defaultTab={detailDefaultTab} onSave={handleSaveQuestion} onDelete={handleDeleteQuestion} />
