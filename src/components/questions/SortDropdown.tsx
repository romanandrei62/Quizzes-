    ...
    <>
      ...
      <AnimatePresence>
        ...
        <motion.div
          ...
          className="fixed sm:absolute left-4 right-4 sm:left-auto sm:right-0 mt-2 sm:w-72 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50 max-h-[70vh] overflow-y-auto"
          style={{
