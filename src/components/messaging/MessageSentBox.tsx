...
const MOCK_SENT_MESSAGES: SentMessage[] = [
{
  ...
  preview:
  'Thanks for sharing the slides. I reviewed them and have a few suggestions for the timeline section...',
...
},
{
  ...
  preview:
  'I need access to the staging server to deploy the latest updates. Can you grant me permissions?',
...
},
{
  ...
  preview:
  'Following up on our discussion about the project requirements. Here are the revised timelines...',
...
export function MessageSentBox({ onSelectMessage }: MessageSentBoxProps) {
              ...
              className="flex-shrink-0 hidden md:block" />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="md:hidden">
                    ...
                    <div className="flex items-center gap-0.5 px-1.5 py-0.5 bg-gray-100 text-gray-600 rounded-full flex-shrink-0">
                  ...
                  <span className="text-xs flex-shrink-0 text-gray-400">
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {message.replyCount && message.replyCount > 0 &&
                  <div className="flex items-center gap-1 px-2 py-0.5 rounded-full text-xs bg-gray-100 text-gray-600 flex-shrink-0">
                          <MessageCircle className="h-3 w-3" />
