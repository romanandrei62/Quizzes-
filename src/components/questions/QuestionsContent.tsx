...
export const MOCK_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    text: 'Which of the following is the correct procedure when encountering a safety hazard in the workplace?',
    type: 'multiple',
    category: 'compliance',
    createdAt: new Date('2023-12-30T09:15:00'),
    status: 'active',
    options: [
      'Report immediately',
      'Ignore if minor',
  ...
  },
  {
    ...
    text: 'Describe the proper steps for handling sensitive customer data according to our data protection policy.',
    type: 'open',
    category: 'compliance',
    createdAt: new Date('2023-12-29T14:30:00'),
    status: 'active',
  },
  {
    id: '18',
    title: 'Password Policy Compliance',
    text: 'All employees must change their passwords every 90 days and use at least 12 characters including uppercase, lowercase, numbers, and special characters.',
    type: 'true-false',
    category: 'compliance',
  ...
  },
  {
    ...
    text: 'Match each department with its primary responsibility within the organization.',
    type: 'matching',
    category: 'onboarding',
  ...
  },
  {
    ...
    text: 'Which communication channel should be used for urgent cross-team issues that require immediate attention?',
    type: 'multiple',
    category: 'onboarding',
    createdAt: new Date('2023-12-26T08:20:00'),
    status: 'active',
    options: [
      'Email',
      'Slack #urgent',
  ...
  },
  {
    ...
    text: 'Our API enforces a rate limit of 1000 requests per minute per API key, with automatic throttling applied when the limit is exceeded.',
    type: 'true-false',
    category: 'knowledge',
    createdAt: new Date('2023-12-25T13:10:00'),
    status: 'active',
  },
  {
    id: '22',
    title: 'Customer Onboarding Steps',
    text: 'What is the recommended first step when onboarding a new enterprise customer to our platform?',
    type: 'multiple',
    category: 'onboarding',
  ...
  },
  {
    ...
    text: 'Describe the most effective methods for collecting actionable feedback from end users during a product beta phase.',
    type: 'open',
    category: 'assessment',
    createdAt: new Date('2023-12-23T15:30:00'),
    status: 'draft',
  },
  {
    id: '24',
    title: 'Security Terminology',
    text: 'Match the following security terms with their correct definitions.',
    type: 'matching',
    category: 'compliance',
    createdAt: new Date('2023-12-22T09:45:00'),
    status: 'active',
  },
  {
    id: '25',
    title: 'Incident Response',
    text: 'In the event of a data breach, the first step is to immediately notify all affected customers before investigating the scope of the incident.',
    type: 'true-false',
    category: 'compliance',
    createdAt: new Date('2023-12-21T14:00:00'),
    status: 'active',
  },
  {
    id: '26',
    title: 'Product Roadmap Awareness',
    text: 'Which upcoming feature has been prioritized for the Q2 release based on customer feedback and strategic alignment?',
    type: 'multiple',
    category: 'knowledge',
  ...
  },
  {
    ...
    text: 'Explain the key components of our quarterly performance review process and how employees should prepare for their review meetings.',
    type: 'open',
    category: 'onboarding',
    createdAt: new Date('2023-12-19T16:15:00'),
    status: 'active',
  },
  {
    id: '28',
    title: 'Tool Proficiency Assessment',
    text: 'Match each internal tool with its primary use case within our workflow.',
    type: 'matching',
    matchSubType: 'image',
    category: 'knowledge',
    createdAt: new Date('2023-12-18T08:45:00'),
    status: 'active',
  },
  {
    id: '29',
    title: 'Remote Work Guidelines',
    text: 'Remote employees are required to be available during core hours (10 AM - 3 PM) in their local timezone regardless of their flexible schedule arrangement.',
    type: 'true-false',
    category: 'compliance',
    createdAt: new Date('2023-12-17T13:20:00'),
    status: 'active',
  },
  {
    id: '30',
    title: 'Client Escalation Path',
    text: 'What is the correct escalation path when a client reports a critical production issue outside of business hours?',
    type: 'multiple',
    category: 'knowledge',
    createdAt: new Date('2023-12-16T10:00:00'),
    status: 'active',
    options: [
      'On-call engineer → Team lead → VP Engineering',
      'Email support → Wait for morning',
      'Direct message CEO',
      'Log ticket and wait',
    ],
  },
  {
    ...
    text: 'Describe the process for enrolling in company benefits during the annual open enrollment period, including key deadlines and required documentation.',
    type: 'open',
    category: 'onboarding',
    createdAt: new Date('2023-12-15T15:00:00'),
    status: 'draft',
  },
  {
    id: '32',
    title: 'Code Review Standards',
    text: 'All pull requests must receive at least two approvals from senior engineers before being merged into the main branch.',
    type: 'true-false',
    category: 'knowledge',
    createdAt: new Date('2023-12-14T09:30:00'),
    status: 'active',
  },
  {
    id: '33',
    title: 'Compliance Training Modules',
    text: 'Match each compliance training module with its required completion frequency.',
    type: 'matching',
    category: 'compliance',
    createdAt: new Date('2023-12-13T14:45:00'),
    status: 'active',
  },
  {
    id: '34',
    title: 'Customer Segmentation',
    text: 'Which customer segment represents the highest lifetime value based on our current analytics data?',
    type: 'multiple',
    category: 'assessment',
    createdAt: new Date('2023-12-12T11:15:00'),
    status: 'active',
    options: [
  ...
  },
  {
    ...
    text: 'Provide a high-level overview of our platform architecture, including the key services, data flow patterns, and how they interact to deliver the end-user experience.',
    type: 'open',
    category: 'knowledge',
