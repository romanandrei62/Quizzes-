      ...
      <motion.div
        ...
        <div className="flex items-center gap-2 sm:gap-4 md:gap-6 min-w-0 flex-1">
          ...
          <motion.div
            ...
            <button
              onClick={onEdit}
              className="flex items-center gap-2 px-3 sm:px-4 py-2 text-sm font-medium bg-white/10 hover:bg-white/20 rounded-lg transition-all duration-200 backdrop-blur-sm border border-white/10">

              <Pencil className="w-4 h-4" />
              <span className="hidden lg:inline">Edit</span>
            </button>
            <ApplyActionsDropdown
